...
***There are `r ncol(Whickham)` variables in the dataset. Both `outcome` and `smoker` are character data that are 2 level factros and `age` is numerical data.***
...
***I would expect smokers to have increasingly worse health and have greater deaths.***
...
```
***The results were different than I expected because it seems that less smokers die than people who do smoke.***
